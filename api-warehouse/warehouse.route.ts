...
import { type ShelfId, type BookID, type OrderId, type FulfilledBooks, type OrderPlacement, type Order } from '../api-books/documented_types'
import { placeBooksOnShelf } from '../api-orders/place_on_shelf'
import { fulfilOrder } from '../api-orders/fulfil_order'
import { placeOrder } from '../api-orders/place_order'
import { listOrders } from '../api-orders/list_orders'
